...
export const getAliments = createAsyncThunk(
...
export const alimentsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      .addCase(getAliments.pending, (state) => {
      ...
      .addCase(getAliments.rejected, (state) => {
        state.loadingAlimentsList = false;
      });
  },
});

export const { updateSearchedAlimentList } = alimentsSlice.actions;
